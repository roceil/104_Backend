...
import { postInvitation, getInvitationList, getInvitationById, cancelInvitation, deleteInvitation, finishInvitationDating, getInvitationListAggregation } from "@/controllers/invitationController"
import isAuth from "@/middlewares/isAuth"
import { postInvitationSwagger, getInvitationListSwagger, getInvitationByIdSwagger, cancelInvitationSwagger, deleteInvitationSwagger, finishInvitationDatingSwagger, getInvitationListAggregationSwagger } from "@/middlewares/swaggerConfig/invitationSwagger"
const router = Router()
...
router.get("/i-invite-who-listA", getInvitationListAggregationSwagger, isAuth, asyncErrorHandler(getInvitationListAggregation) as RequestHandler)
