...
import { postInvitation, getInvitationList, getInvitationById, cancelInvitation, deleteInvitation } from "@/controllers/invitationController"
import isAuth from "@/middlewares/isAuth"
import { postInvitationSwagger, getInvitationListSwagger, getInvitationByIdSwagger, cancelInvitationSwagger, deleteInvitationSwagger } from "@/middlewares/swaggerConfig/invitationSwagger"
const router = Router()
