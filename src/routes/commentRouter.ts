...
import { postComment, getCommentList, getCommentById, putComment, deleteComment } from "@/controllers/commentController"
import isAuth from "@/middlewares/isAuth"
import { checkUnlockComment } from "@/middlewares/checkUnlockComment"
import { asyncHandler } from "@/middlewares/swaggerConfig/asyncHandler"
import { postCommentSwagger, getCommentListSwagger, getCommentByIdSwagger, putCommentSwagger, deleteCommentSwagger } from "@/middlewares/swaggerConfig/commentSwagger"
const router = Router()
...
router.get("/comment-i-left/:id", getCommentByIdSwagger, isAuth, asyncHandler(checkUnlockComment), asyncErrorHandler(getCommentById) as RequestHandler)
