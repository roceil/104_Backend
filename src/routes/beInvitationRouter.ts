...
import { getWhoInvitationList, getWhoInvitationById, cancelBeInvitation, rejectInvitation, acceptInvitation, deleteBeInvitation, finishBeInvitationDating, getWhoInvitationListWithAggregation } from "@/controllers/beInvitationController"
import isAuth from "@/middlewares/isAuth"
import { getWhoInvitationListSwagger, getBeInvitationByIdSwagger, rejectInvitationSwagger, cancelBeInvitationSwagger, acceptInvitationSwagger, deleteBeInvitationSwagger, finishBeInvitationDatingSwagger, getWhoInvitationListByAggregationSwagger } from "@/middlewares/swaggerConfig/beInvitationSwagger"
const router = Router()
...
router.get("/who-invite-me-listA", getWhoInvitationListByAggregationSwagger, isAuth, asyncErrorHandler(getWhoInvitationListWithAggregation) as RequestHandler)
